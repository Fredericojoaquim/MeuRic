...
@section('title', 'RIC-Estatíticas')
@section('location', 'Estatíticas')
    ...
    <div class="container" style="height: 300px;">
        <div class="row no-gutters slider-text align-items-end justify-content-center" style="height: 300px;">
            <div class="col-md-9 ftco-animate pb-5 text-center">
                <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Pagina Inicial <i class="fa fa-chevron-right"></i></a></span> <span>Estatíticas <i class="fa fa-chevron-right"></i></span></p>
                <h1 class="mb-0 bread">Estatíticas</h1>
            </div>
        </div>
    </div>
</section>
