...
@section('title', 'RIC-Preecorrer por Título')
@section('location', 'Precorrer por Título')
@section('styles')
    <style>
        .label.label-default {
            ...
            <div class="row no-gutters slider-text align-items-end justify-content-center" style="height: 300px;">
                <div class="col-md-9 ftco-animate pb-5 text-center">
                    <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Pagina Inicial <i
                                    class="fa fa-chevron-right"></i></a></span> <span>Precorrer por Título <i
                                class="fa fa-chevron-right"></i></span></p>
                    <h1 class="mb-0 bread">Percorrer por Título</h1>
                </div>
            </div>
        </div>
    </section>
                                    ...
                                    @if (isset($trabalhos) && $trabalhos->count() > 0)
                                        @foreach ($trabalhos as $trabalho)
                                            <tr>
                                                ...
                                                <td headers="t2">
                                                    <strong>
                                                        <a href="{{ url("percorrer/por-titulo/$trabalho->id") }}">
