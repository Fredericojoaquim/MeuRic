            ...
            <div class="row no-gutters slider-text align-items-center justify-content-center">
                <div class="col-md-9 ftco-animate pb-5 text-center">
                    ...
                    <p class="py-4">Obtenha como resultado todos os trabalhos
                        ...
                        computação.</p>
                    {{ csrf_field() }}
                    <form method="GET" action="{{url('#')}}" id="home_search_form_2"
                        class="home_search_form d-flex flex-lg-row flex-column align-items-center justify-content-center">
                        <div class="d-flex flex-row align-items-center justify-content-center">
                            <input type="search" class="home_search_input" placeholder="Palavra-chave" id="pesquisar"
                                name="pesquisar" required="required">
                ...
                <div class="col-md-6 heading-section pr-md-5 ftco-animate d-flex align-items-center">
                    <div class="w-100 mb-4 mb-md-0">
                        ...
                        <div class="d-flex video-image align-items-center mt-md-4">
                            <a href="{{ url("#") }}" class="btn btn-primary py-2 px-3">Saiba mais</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                        ...
                        <div class="col-md-12 col-lg-6 d-flex align-self-stretch ftco-animate">
                            <div class="services">
                                ...
                                <div class="media-body">
                                    ...
                                    <p>Mais de
                                        <span class="badge bg-secondary text-sm">30</span> teses de dissertações produzindas
                                        ao ano
                                    </p>
                                </div>
                            </div>
