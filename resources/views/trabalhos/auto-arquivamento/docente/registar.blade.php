    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <h4 class="card-title text-center text-primary"> <strong>Auto-Arquivamento</strong> </h4>
                <form id="regForm" class="forms-sample without-margin" action="{{url('trabalho/autoarquivamento/salvar')}}" method="POST" enctype="multipart/form-data" >
                    @csrf 
                    ...
                    <div class="tab">
                      ...
                      <div class="form-group">
                       ...
                       <p><input class="form-control myinput" placeholder="Autor1, Autor2, Autor 3 ....." name="autor" value="{{ old('autor') }}"></p>
                      </div>
                    ...
                    <div class="tab">
                            ...
                            <div class="form-group">
                              <label>Título</label>
                              <p><input placeholder="Título" value="{{ old('titulo') }}"  class="form-control" name="titulo"></p>
                            </div>

                            <div class="form-group">
                              <label>Língua</label>
                              <p><input placeholder="Língua" value="{{ old('lingua') }}" class="form-control" name="lingua"></p>
                            </div>

                            <div class="form-group">
                              <label>Local</label>
                              <p><input placeholder="Local" value="{{ old('local') }}" class="form-control" name="local"></p>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea  class="form-control" name="palavra" placeholder="palavras chaves" id="exampleFormControlTextarea1" rows="4">{{ old('palavra') }}</textarea>
                        </div>
                        <div class="form-group">
                          <label for="exampleFormControlTextarea1">Resumo</label>
                          <p><textarea  class="form-control" name="resumo" placeholder="Resumo do seu trabalho" id="exampleFormControlTextarea1" rows="4">{{ old('resumo') }}</textarea></p>
                      </div>

                      <div class="form-group">
                        <label for="fontes">Fontes</label>
                        
                        <p><textarea  class="form-control" name="fontes" placeholder="referencias do seu trabalho" id="fontes" rows="4">{{ old('fontes') }}</textarea></p>
                      </div>
                </div>
                    ...
                    <div class="tab">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" value="{{ old('arquivo') }}" name="arquivo" class="file-upload-default">
