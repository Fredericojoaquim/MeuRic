      ...
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
        ...
        <div>
          <a class="navbar-brand brand-logo" href="index.html">
            <img src="{{asset('images/logos/mylogo.png')}}" class="logo" alt="logo"/>
          </a>
      ...
      <div class="navbar-menu-wrapper d-flex align-items-top"> 
        <ul class="navbar-nav">
          <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
            @if(Auth::check())
            <h1 class="welcome-text">Bem-Vindo, <span class="text-black fw-bold">{{Auth::user()->name}}</span></h1>
            @else
            <h1 class="welcome-text">Usuário não autenticado <span class="text-black fw-bold"></span></h1>
            @endif
          ...
          <li class="nav-item dropdown d-none d-lg-block user-dropdown">
            ...
            @auth
              <form action="{{url('/logout')}}" method="POST">
                   @csrf
                   <a class="dropdown-item"><i class="dropdown-item-icon mdi mdi-power text-primary me-2" href="{{url('/logout')}}" onclick="event.preventDefault(); this.closest('form').submit();"></i>Sign Out</a>
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="{{url('trabalho/autoarquivamento/create')}}">Registar</a></li>
                <li class="nav-item"><a class="nav-link" href="{{url('trabalho/autoarquivamento/listar')}}">Meus trabalhos</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            ...
            <div class="collapse" id="charts">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{url('trabalho/mediado/create')}}">Registar</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{url('trabalho/arquivamento-mediado/listar')}}">Listar</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
