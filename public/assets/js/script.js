...
if($('.datatable').length>0){$('.datatable').DataTable({"bFilter":false,language: {url: '//cdn.datatables.net/plug-ins/1.13.4/i18n/pt-PT.json',},});}
if($('.datatables').length>0){$('.datatables').DataTable({"bFilter":true,language: {url: '//cdn.datatables.net/plug-ins/1.13.4/i18n/pt-PT.json',},});}
